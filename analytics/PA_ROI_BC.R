...
# Please don't load any libraries that you are not using
#library(arsenal)
#library(readr)
#library(foreach)
#library(stringr)
...
physical_activity_ROI <- physical_activity_ROI %>% mutate(  true_missing = case_when(
  is.na(SrvMRE_WalkHikeOften_v1r0) & is.na(SrvMRE_WalkHikeTime_v1r0) & is.na(SrvMRE_WalkHikeSpring_v1r0) & is.na(SrvMRE_WalkHikeSummer_v1r0) & 
  is.na(SrvMRE_WalkHikeFall_v1r0) & is.na(SrvMRE_WalkHikeWinter_v1r0) & is.na(SrvMRE_JogRunOften_v1r0) & is.na(SrvMRE_JogRunTime_v1r0) & 
  is.na(SrvMRE_JogRunSpring_v1r0) & is.na(SrvMRE_JogRunSummer_v1r0) & is.na(SrvMRE_JogRunFall_v1r0) & is.na(SrvMRE_JogRunWinter_v1r0) &    
  is.na(SrvMRE_TennisOften_v1r0) & is.na(SrvMRE_TennisTime_v1r0) & is.na(SrvMRE_TennisSpring_v1r0) & is.na(SrvMRE_TennisSummer_v1r0) & 
  is.na(SrvMRE_TennisFall_v1r0) & is.na(SrvMRE_TennisWinter_v1r0) & is.na(SrvMRE_GolfOften_v1r0) & is.na(SrvMRE_GolfTime_v1r0) & 
  is.na(SrvMRE_GolfSpring_v1r0) & is.na(SrvMRE_GolfSummer_v1r0) & is.na(SrvMRE_GolfFall_v1r0) & is.na(SrvMRE_GolfWinter_v1r0) &    
  is.na(SrvMRE_SwimLapsOften_v1r0) & is.na(SrvMRE_SwimLapsTime_v1r0) & is.na(SrvMRE_SwimLapsSpring_v1r0) & is.na(SrvMRE_SwimLapsSummer_v1r0) & 
  is.na(SrvMRE_SwimLapsFall_v1r0) & is.na(SrvMRE_SwimLapsWinter_v1r0) & is.na(SrvMRE_BikeOften_v1r0) & is.na(SrvMRE_BikeTime_v1r0) & 
  is.na(SrvMRE_BikeSpring_v1r0) & is.na(SrvMRE_BikeSummer_v1r0) & is.na(SrvMRE_BikeFall_v1r0) & is.na(SrvMRE_BikeWinter_v1r0) &
  is.na(SrvMRE_StrengthOften_v1r0) & is.na(SrvMRE_StrengthTime_v1r0) & is.na(SrvMRE_StrengthSpring_v1r0) & is.na(SrvMRE_StrengthSummer_v1r0) & 
  is.na(SrvMRE_StrengthFall_v1r0) & is.na(SrvMRE_StrengthWinter_v1r0) & is.na(SrvMRE_YogaOften_v1r0) & is.na(SrvMRE_YogaTime_v1r0) & 
  is.na(SrvMRE_YogaSpring_v1r0) & is.na(SrvMRE_YogaSummer_v1r0) & is.na(SrvMRE_YogaFall_v1r0) & is.na(SrvMRE_YogaWinter_v1r0) &    
  is.na(SrvMRE_MAOften_v1r0) & is.na(SrvMRE_MATime_v1r0) & is.na(SrvMRE_MASpring_v1r0) & is.na(SrvMRE_MASummer_v1r0) & is.na(SrvMRE_MAFall_v1r0) & 
